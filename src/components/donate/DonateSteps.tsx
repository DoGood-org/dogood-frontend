  ...
  return (
    <Section withContainer={false} className="">
      <Container className="flex flex-col items-center">
        ...
        <h2 className="order-2 mt-20 mb-10 text-xl text-center lg:text-2xl sm:text-h2 lg:order-1">
          {donateText.title}
        </h2>
        ...
        <div className="flex flex-col items-center justify-center order-3 gap-8 lg:flex-row lg:order-2">
          ...
          <ul className="flex flex-col max-w-xl gap-16">
            {donateText.items.map((step: any, index: number) => (
              <li key={step.title} className="flex flex-col gap-2 text-base">
