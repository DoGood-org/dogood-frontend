...
import commentList from './reviews.json';
  ...
  return (
    <Section withContainer={false}>
      <div className="reviews-section">
        <Container>
          <div className="flex flex-col lg:items-end md:pt-6 lg:pt-[22px] ">
            <h2 className="flex text-white self-end items-end justify-end flex-wrap text-h1 md:w-[353px] lg:w-[625px] lg:text-h3-d">
              {t('reviewTitle')}
              <p className="flex">
                <span className="flex indent-2 text-border">Do</span>
                Good
              </p>
            </h2>
            <div
              className="flex flex-col md:flex-row gap-6 mt-[147px] md:mt-[93px] lg:mt-10 md:pb-10 lg:pb-[54px]
            "
            >
