...
export const OrgItem = ({
  ...
  return (
    <Link
      ...
      className="flex justify-between w-full p-3 rounded-lg lg:p-6 bg-card md:gap-8"
    >
      <div className="flex gap-4">
        <Image
          ...
          width={75}
          height={75}
          className="shrink-0 w-[75px] h-[75px] object-cover rounded-lg self-center md:self-start"
        />
