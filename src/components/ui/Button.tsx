  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-base transition-all disabled:pointer-events-none [&_svg:not([class*="size-"])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-btn-hover aria-invalid:border-destructive cursor-pointer',
  {
    variants: {
      variant: {
        ...
        primary:
          'text-btn-text text-base text-white bg-btn overflow-hidden hover:bg-btn-hover focus:bg-btn-hover active:bg-btn-active group transition-colors duration-500',
        secondary:
          'text-btn-secondary border-1 border-btn-outline hover:shadow-[0_0_0_1px_var(--btn-outline-hover)] focus:shadow-[0_0_0_1px_var(--btn-outline-hover)] outline-btn-outline-hover hover:border-btn-outline-hover focus:border-btn-outline-hover',
        filters: 'bg-card',
        tag: 'bg-tag gap-2',
